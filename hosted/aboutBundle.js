...
var aboutPage = function aboutPage(){
  return React.createElement(
      ...
      React.createElement(
        "img",
        { src: "assets/img/MyDad.jpg", alt: "My Dad", className: "aboutImg" },
      ),
      React.createElement(
        "p",
        { className: "aboutInfo" },
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: "https://venmo.com/Jake-Recoon", className: "aboutLink" },
          "here",
        ),
...
var setup = function setup(csrf) {
  ReactDOM.render(React.createElement(aboutPage, { jokes: [] }), document.querySelector("#about"));
};
